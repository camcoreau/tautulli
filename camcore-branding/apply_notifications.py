...
def _camcore_notification_html(subject, body, action):
    ...
    return f'''<!doctype html><html lang="en-AU"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#F4F6F8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#101720;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#F4F6F8;width:100%;"><tr><td align="center" style="padding:34px 12px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:640px;max-width:640px;margin:0 auto;"><tr><td style="padding:22px 32px 18px;background:#101720;border-radius:12px 12px 0 0;">{{brand_html}}<div style="margin-top:14px;color:#C7CDD5;font-size:10px;line-height:15px;font-weight:700;letter-spacing:1.8px;">CAMCORE MEDIA • INSIGHTS</div></td></tr><tr><td style="height:4px;line-height:4px;font-size:0;background:#FF4B2B;">&nbsp;</td></tr><tr><td style="padding:36px 32px 32px;background:#ffffff;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 16px;"><tr><td style="padding:5px 10px;background:#FFF3EF;border:1px solid #FFD1C7;border-radius:999px;color:#C8321A;font-size:10px;line-height:13px;font-weight:800;letter-spacing:1.2px;">{{event_label}}</td></tr></table><h1 style="margin:0;color:#101720;font-size:31px;line-height:38px;font-weight:800;letter-spacing:-0.55px;">{{subject_html}}</h1><p style="margin:18px 0 0;color:#435562;font-size:15px;line-height:24px;">{{body_html}}</p><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:24px 0 0;"><tr><td style="padding:18px 20px;background:#F4F6F8;border:1px solid #DDE2E7;border-radius:9px;color:#101720;"><div style="margin:0 0 8px;color:#667180;font-size:10px;line-height:14px;font-weight:750;letter-spacing:1.4px;">MONITORING SERVICE</div><div style="color:#101720;font-size:15px;line-height:22px;font-weight:750;">CamCore Media Insights</div><div style="margin-top:5px;color:#526572;font-size:13px;line-height:20px;">Monitoring and analytics for Cameron-Media.</div></td></tr></table>{{button_html}}</td></tr><tr><td style="padding:24px 32px 26px;background:#F4F6F8;border-top:1px solid #DDE2E7;border-radius:0 0 12px 12px;text-align:center;"><div style="color:#101720;font-size:13px;line-height:18px;font-weight:750;">CamCore Media Insights</div><div style="margin-top:2px;color:#667180;font-size:11px;line-height:16px;">Cameron Family Secure Network</div><div style="margin-top:12px;font-size:12px;line-height:19px;"><a href="https://plex.camcore.au/" style="color:#C8321A;font-weight:650;text-decoration:none;">Cameron-Media</a>&nbsp;&nbsp;•&nbsp;&nbsp;<a href="https://status.camcore.au/" style="color:#C8321A;font-weight:650;text-decoration:none;">Service Status</a>&nbsp;&nbsp;•&nbsp;&nbsp;<a href="https://camcore.au/support.html" style="color:#C8321A;font-weight:650;text-decoration:none;">CamCore Support</a></div><div style="margin-top:4px;font-size:12px;line-height:18px;"><a href="mailto:help@camcore.au" style="color:#C8321A;font-weight:650;text-decoration:none;">help@camcore.au</a></div></td></tr></table></td></tr></table></body></html>'''
